...
// Отримуємо дані для занесення в базу
...
// Якщо поля автор або коментар пусті - то помилка
...
// Якщо все добре то ми додаємо коментар у базу comments_t. 
// При додаванні нових записів - алгоритм точно такий самий, але "демо" база буде називатися "data_in_m". 
// З цим закінчили. Тепер відкрий файл index.php в папці admin
	
$date = date("Y-m-d");
$result2 = mysql_query ("INSERT INTO comments_t (post,author,text,date) VALUES ('$id','$author','$text','$date')",$db);
