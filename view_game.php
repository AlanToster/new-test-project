...
<td width="584" valign="top" class="maintext">
<p class="view_title"><?php echo $myrow['title'] ?></p>
<p class="view_descr"><?php echo $myrow['description'] ?></p>
<p class="dates">Дата: <?php echo $myrow['date'] ?></p>

<center><? printf("<object type=application/x-shockwave-flash data=%s style='height: 370px; width: 520px;'></object>",$myrow['url']);?></center>
<?
if ($myrow["author"] != "") {
